...
export class LearnVocaComponent implements OnInit, OnDestroy {
  ...
  getListVoca() {
    this.apiService.getListVoca().subscribe((res) => {
  ...
  selectTopic(topic: Topic) {
    this.router.navigate(['/student/tu-vung', topic.id]);
  ...
  loadMoreVocabularies() {
    ...
    setTimeout(() => {
      ...
      const newVocabularies = this.filteredVocabularies.slice(
        startIndex,
        endIndex
      );
